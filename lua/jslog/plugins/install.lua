...
require("lazy").setup({
  ...
  -----------------------------------
  {
    ...
    dependencies = {
      {
        "williamboman/mason.nvim", --[[version = see shared dependencies at top of file --]]
      },
  ...
  ----------------------------------------
  {
    ...
    dependencies = {
      ...
      { "marilari88/neotest-vitest", tag = "v0.2.0" },
      {
        ...
        version = "514fd4eae7da15fd409133086bb8e029b65ac43f",
      },
      {
        "nvim-neotest/neotest-go",
        version = "6a2f996d89fe4631942e035b1c114544ee045043",
      },
    },
  },
  ----------------------------------------
  ...
  { "kdheepak/lazygit.nvim", version = "0ada6c6e7e138df92f5009b6952f4ac41248305a" },
  {
    ...
    dependencies = {
      ...
      },
      {
        ...
        version = "429174d53652dbef56868a2cbeb8b28cb5d44fdd",
        ----------------------------------------
        --....................................--
